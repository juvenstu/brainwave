  ...
  <>
    ...
    >
      <path
        ...
        stroke={white ? "white" : "url(#btn-left)"} // mentioned in ButtonGradient.tsx
        strokeWidth="2"
    ...
    >
      {white ? (
        ...
        <>
          <polygon
            fill="url(#btn-top)" // mentioned in ButtonGradient.tsx
            fillRule="nonzero"
            points="100 42 100 44 0 44 0 42"
          />
          <polygon
            fill="url(#btn-bottom)" // mentioned in ButtonGradient.tsx
            fillRule="nonzero"
    ...
    >
      <path
        fill={white ? "white" : "none"}
        stroke={white ? "white" : "url(#btn-right)"} // mentioned in ButtonGradient.tsx
        strokeWidth="2"
